 ...
 */
final class Version20200425161019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE generador ADD email VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP title, DROP slug, DROP description, DROP content, DROP publish_since, DROP publish_until, DROP publish_status, DROP created_at, DROP modified_at');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D688D800E7927C74 ON generador (email)');
        $this->addSql('ALTER TABLE recolector ADD email VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP title, DROP slug, DROP description, DROP content, DROP publish_since, DROP publish_until, DROP publish_status, DROP created_at, DROP modified_at');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2CB9AA69E7927C74 ON recolector (email)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_D688D800E7927C74 ON generador');
        $this->addSql('ALTER TABLE generador ADD title VARCHAR(128) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD slug VARCHAR(128) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD description VARCHAR(256) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, ADD content LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_since LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_until LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_status VARCHAR(32) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD created_at DATETIME NOT NULL, ADD modified_at DATETIME DEFAULT \'NULL\', DROP email, DROP roles, DROP password');
        $this->addSql('DROP INDEX UNIQ_2CB9AA69E7927C74 ON recolector');
        $this->addSql('ALTER TABLE recolector ADD title VARCHAR(128) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD slug VARCHAR(128) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD description VARCHAR(256) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, ADD content LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_since LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_until LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD publish_status VARCHAR(32) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD created_at DATETIME NOT NULL, ADD modified_at DATETIME DEFAULT \'NULL\', DROP email, DROP roles, DROP password');
